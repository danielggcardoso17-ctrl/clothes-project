...
const Hero = () => {
  return (
    <section
      id="inicio"
      className="relative overflow-hidden rounded-3xl bg-primary px-6 py-20 text-primary-foreground shadow-2xl sm:px-10 lg:px-14"
    >
      <Meteors number={40} />
      <span className="relative inline-flex overflow-hidden items-center gap-2 rounded-full border border-primary-foreground/25 bg-primary-foreground/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-primary-foreground/90">
      ...
      <div id="colecoes" className="mt-10 grid gap-3 sm:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-primary-foreground/15 bg-primary-foreground/10 p-4">
